...
var _CustomScrollbar = require('./utils/CustomScrollbar');
  ...
  Popup.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'scheduler-popup-date' },
          (0, _moment2.default)(props.slotStart).format("DD")
        ),
        _react2.default.createElement(
          'div',
          { className: 'scheduler-popup-week-date' },
          (0, _moment2.default)(props.slotStart).format("dddd")
        )
      ),
      _react2.default.createElement(
        'div',
